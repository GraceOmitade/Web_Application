...
;(function($, undefined) {
	...
	var page = {
		init: function() {
			...
			// Menu Parent
			$('.menu ul .parent > a').append('<i class="fa fa-angle-right pull-right" style="margin-top: 2px;"></i>');

			// Nav Stacked Parent
			$('.nav-stacked .parent > a').append('<i class="fa fa-chevron-right pull-right" style="margin-top: 5px;"></i>');
